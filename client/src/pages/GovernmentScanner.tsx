...
const GovernmentScanner: React.FC = () => {
  ...
  const save = async () => {
    ...
    setError(null);
    try {
      await addDoc(collection(db, "government_scans"), { health_id: healthId.trim().toUpperCase(), note, createdAt: serverTimestamp() });
...
export default GovernmentScanner;
